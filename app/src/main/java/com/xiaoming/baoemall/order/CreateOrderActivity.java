...
import com.xiaoming.baoemall.order.adapter.WareOrderAdapter;
import com.xiaoming.baoemall.order.bean.Charge;
import com.xiaoming.baoemall.order.layoutmanager.FullyLinearLayoutManager;
import com.xiaoming.baoemall.order.net.CreateOrderRespMsg;
import com.xiaoming.baoemall.pay.PayResultActivity;
import com.xiaoming.baoemall.utils.CartProvider;
import com.xiaoming.baoemall.utils.JSONUtil;
...
public class CreateOrderActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void postNewOrder(){
        ...
        if(EmallApplication.getInstance().getUser() != null) {
            params.put("user_id", EmallApplication.getInstance().getUser().getId()+"");
        }
